        ...
        <div class="bg-white rounded shadow p-2 mt-4" style="min-height:80vh">
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" name="resume_title" placeholder="WebD Consultant" 
                        value="<?=@$resume['resume_title']?>" class="form-control" required>
                    </div>   
                <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    <div class="col-md-6">
                        <label class="form-label">Full Name</label>
                        <input type="text" value="<?=@$resume['full_name']?>"name="full_name" placeholder="Shaili Chauhan" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" value="<?=@$resume['email_id']?>" name="email_id" placeholder="abc@gmail.com" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" value="<?=@$resume['objective']?>" name="objective"><?=@$resume['objective']?></textarea>
                    </div>
                    <div class="col-md-6">
...
<div class="modal-dialog modal-dialog-centered">
  ...
  <div class="col-12">
    ...
    <input type="text" name="started" class="form-control" placeholder="March 2023"  id="inputPassword4" required>
    </div>
    <div class="col-md-6">
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Educations</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
